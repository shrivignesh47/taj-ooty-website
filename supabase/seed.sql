...
-- Create auth users via Supabase Auth API (local dev only)
-- Users are created through the GoTrue auth system, not direct SQL inserts
-- Use supabase.auth.signUp() from the app or the local auth endpoint
