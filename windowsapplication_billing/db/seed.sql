-- ============================================================================
-- TajPOS - Seed Data for Local PostgreSQL 16
-- Converted from supabase/seed.sql (Supabase Auth inserts removed)
-- Includes data-only inserts from migrations (permissions, stations, coupons)
-- ============================================================================
...
-- ─── Permissions ──────────────────────────────────────────────────────────────
-- Core permissions from seed.sql + advanced permissions from migrations
-- (008_additional_permissions, 020_add_view_menu_permission, 023, 034)
...
WHERE r.name = 'cashier' AND p.key IN (
  ...
  'apply_discount', 'view_reports', 'manage_cash_drawer', 'manage_expenses'
)
ON CONFLICT DO NOTHING;
...
-- =============================================
-- Default staff users for local Windows install
-- Passwords use bcrypt via pgcrypto crypt()
-- Change these during Setup Wizard
-- =============================================

-- Insert into staff_users first
INSERT INTO staff_users (id, auth_id, name, phone, role_id, is_active, created_at)
VALUES 
  ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 
   'Admin', '', (SELECT id FROM roles WHERE name = 'admin'), true, now()),
  ('00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002',
   'Waiter', '', (SELECT id FROM roles WHERE name = 'waiter'), true, now()),
  ('00000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000003',
   'Kitchen', '', (SELECT id FROM roles WHERE name = 'kitchen'), true, now()),
  ('00000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000004',
   'Cashier', '', (SELECT id FROM roles WHERE name = 'cashier'), true, now())
ON CONFLICT (id) DO NOTHING;

-- Insert into app_users (local auth)
-- Passwords: Admin@123, Waiter@123, Kitchen@123, Cashier@123
...
VALUES
  ...
  ('00000000-0000-0000-0000-000000000002',
   'waiter@tajpos.local',
   crypt('Waiter@123', gen_salt('bf')),
   '00000000-0000-0000-0000-000000000002',
   true),
  ('00000000-0000-0000-0000-000000000003',
   'kitchen@tajpos.local',
   crypt('Kitchen@123', gen_salt('bf')),
   '00000000-0000-0000-0000-000000000003',
   true),
  ('00000000-0000-0000-0000-000000000004',
   'cashier@tajpos.local',
   crypt('Cashier@123', gen_salt('bf')),
   '00000000-0000-0000-0000-000000000004',
   true)
ON CONFLICT (id) DO NOTHING;

SELECT 'TajPOS seed data inserted successfully' AS status;